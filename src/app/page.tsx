        ...
        <div className="mx-auto max-w-2xl py-24 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 dark:text-gray-300 dark:ring-gray-100/10">
              DevSecOps &middot; Racing &middot; Photography
            </div>
          </div>
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
              DevSecOps Engineer skilled in multiple areas including cloud technology, container orchestration, CI/CD, development, security, and compliance. Autocross racer with a passion for photography.
            </p>
